...
def add_to_chroma(chunks: list[Document]):
    try:
        ...
        if len(new_chunks):
            ...
            print(f"New chunk IDs: {new_chunk_ids}")  # Debugging line

            try:
                db.add_documents(new_chunks, ids=new_chunk_ids)
                print("Documents added, now persisting...")  # Debugging line
                db.persist()
                print("Database persisted successfully.")  # Debugging line
            except Exception as e:
                print(f"An error occurred during db.add_documents or db.persist: {e}")
        else:
